...
The dimensions $dim is normalized by L<R::Util#normalize_dim> method, checks normalized dim by L</"R::Util#check_length"> method, and sets this field to its return value.
...
Exceptions thrown by L</"R::Util#check_length"> method could be thrown.
