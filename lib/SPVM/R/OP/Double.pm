...
C<static method rep : L<R::NDArray::Double|SPVM::R::NDArray::Double> ($x_ndarray : R::NDArray, $times : int);>

=head2 rep_length

C<static method rep_length : L<R::NDArray::Double|SPVM::R::NDArray::Double> ($x_ndarray : R::NDArray, $length : int);>
